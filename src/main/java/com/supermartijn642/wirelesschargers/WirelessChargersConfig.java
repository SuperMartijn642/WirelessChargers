...
public class WirelessChargersConfig {
    ...
    static{
        ...
        basicBlockChargerCapacity = builder.comment("How much energy should the Basic Wireless Block Charger be able to store?").define("basicBlockChargerCapacity", 25000, 1000, 1000000);
        ...
        advancedBlockChargerCapacity = builder.comment("How much energy should the Advanced Wireless Block Charger be able to store?").define("advancedBlockChargerCapacity", 100000, 1000, 1000000);
        ...
        basicPlayerChargerCapacity = builder.comment("How much energy should the Basic Wireless Player Charger be able to store?").define("basicPlayerChargerCapacity", 25000, 1000, 1000000);
        ...
        advancedPlayerChargerCapacity = builder.comment("How much energy should the Advanced Wireless Player Charger be able to store?").define("advancedPlayerChargerCapacity", 100000, 1000, 1000000);
