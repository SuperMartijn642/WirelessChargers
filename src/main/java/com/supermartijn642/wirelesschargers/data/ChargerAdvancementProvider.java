...
public class ChargerAdvancementProvider implements IDataProvider {
    ...
    public void run(DirectoryCache hashCache){
        ...
        Advancement no_more_batteries = Advancement.Builder.advancement()
            ...
            .addCriterion("has_charger", InventoryChangeTrigger.Instance.hasItems(ChargerType.ADVANCED_WIRELESS_PLAYER_CHARGER.getItem()))
        ...
        Advancement no_more_cables = Advancement.Builder.advancement()
            ...
            .addCriterion("has_charger", InventoryChangeTrigger.Instance.hasItems(ChargerType.ADVANCED_WIRELESS_BLOCK_CHARGER.getItem()))
